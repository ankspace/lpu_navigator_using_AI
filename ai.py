# lpu navigator  program for GPS
from pynmea import nmea
import matplotlib.pyplot as plt
import serial, time, sys, threading, date
from pynmea import nmea
import matplotlib.pyplot as plt
...
TRX = - 31.1504    #top right longitude
TRY =  75.4158      #top right latitude
BLX =  -31.1532  #bottom left longitude
BLY =  75.4237     #bottom left latitude
BAUDRATE = 4800
